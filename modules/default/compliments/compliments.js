...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Hey Shaun..."],
			morning: ["Good morning, Shaun!", "Enjoy your day!", "How was your sleep?"],
			afternoon: ["Hello, Shaun!", "You look great!", "Looking good today!"],
			evening: ["Wow, you look very happy!", "You look nice!", "Hi, Shaun!"],
			"....-01-01": ["Happy new year!"],
			"....-06-11": ["Happy Birthday, Shaun"],
			"....-05-12": ["Happy Birthday, Sharlina"],
			"....-03-12": ["Happy Birthday, Mum"],
			"....-06-13": ["Happy Birthday, Pa"]
		},
